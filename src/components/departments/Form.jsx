...
const Form = ({ inModal = false, department = 'Medical', leadSource = 'Website Form' }) => {
    ...
    return (
        <section className={inModal ? "p-0" : "px-3 md:px-12 py-4 md:py-8"}>
            <div id="form-section" className="w-full max-w-2xl mx-auto bg-[#D9D9D933] p-3 sm:p-6 md:p-8 lg:p-10 rounded-xl sm:rounded-2xl">
                <div className="mb-4 sm:mb-8">
                    <h2 className="text-[#19628D] text-center">
                        <span className="font-canela font-light text-[1.25rem] sm:text-[1.9rem] md:text-[2rem] leading-tight tracking-normal">Share a few details below to help <br />us</span>
                        <span className="font-canela font-bold italic text-[1.25rem] sm:text-[1.9rem] md:text-[2rem] leading-tight tracking-normal text-[#19628D]"> understand your concern.</span>
                    </h2>
                </div>
